...
from functions import accuracy,data_distribution_map1,data_distribution_map2,\
    data_distribution_map3,preprocess_data_shift,linear_data_generation,non_linear_data_generation
from datetime import datetime
import random
from Algorithm.DFO_alg import DFO_GD

def DFO(X,y,num_iters = 25,d_list = [10,1000,10000],map = 1,strat_features = np.array([1, 6, 8])-1,\
